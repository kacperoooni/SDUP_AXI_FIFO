...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_FIFO is
  ...
  signal \FIFO_elements_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \FIFO_elements_reg[1]_i_1_n_0\ : STD_LOGIC;
  signal \FIFO_elements_reg[2]_i_1_n_0\ : STD_LOGIC;
  signal \FIFO_elements_reg[3]_i_1_n_0\ : STD_LOGIC;
  signal \FIFO_elements_reg[4]_i_1_n_0\ : STD_LOGIC;
  signal \FIFO_elements_reg[5]_i_1_n_0\ : STD_LOGIC;
  signal \FIFO_elements_reg[5]_i_2_n_0\ : STD_LOGIC;
  signal \FIFO_elements_reg[6]_i_1_n_0\ : STD_LOGIC;
  signal \FIFO_elements_reg[7]_i_1_n_0\ : STD_LOGIC;
  signal \FIFO_elements_reg[7]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \FSM_sequential_currState_reg_n_0_[1]\ : STD_LOGIC;
  signal currState_iAXI : STD_LOGIC_VECTOR ( 0 to 0 );
  signal fifo_full : STD_LOGIC;
  signal fifo_full_reg_i_1_n_0 : STD_LOGIC;
  signal fifo_full_reg_i_2_n_0 : STD_LOGIC;
  signal fifo_full_reg_i_3_n_0 : STD_LOGIC;
  ...
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[0]\ : label is "LD";
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FIFO_elements_reg[0]_i_1\ : label is "soft_lutpair5";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[1]\ : label is "LD";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[1]_i_1\ : label is "soft_lutpair5";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[2]\ : label is "LD";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[2]_i_1\ : label is "soft_lutpair1";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[3]\ : label is "LD";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[3]_i_1\ : label is "soft_lutpair1";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[4]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[5]\ : label is "LD";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[5]_i_1\ : label is "soft_lutpair6";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[6]\ : label is "LD";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[6]_i_1\ : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[7]\ : label is "LD";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[7]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_nextState_iAXI_reg[2]_i_1\ : label is "soft_lutpair0";
  attribute FSM_ENCODED_STATES of \FSM_sequential_currState_reg[1]\ : label is "INIT:00,READ:10,IDLE:01,WRITE:11";
  attribute OPT_MODIFIED : string;
  attribute OPT_MODIFIED of \FSM_sequential_nextState_reg[1]\ : label is "MLO";
  attribute XILINX_LEGACY_PRIM of \FSM_sequential_nextState_reg[1]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of fifo_full_reg : label is "LD";
  attribute SOFT_HLUTNM of fifo_full_reg_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of fifo_full_reg_i_2 : label is "soft_lutpair3";
  attribute XILINX_LEGACY_PRIM of fifo_write_rdy_reg : label is "LD";
  attribute SOFT_HLUTNM of fifo_write_rdy_reg_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of fifo_write_rdy_reg_i_2 : label is "soft_lutpair4";
  attribute XILINX_LEGACY_PRIM of iAXI_ready_reg : label is "LD";
  attribute SOFT_HLUTNM of iAXI_ready_reg_i_2 : label is "soft_lutpair4";
begin
\FIFO_elements_reg[0]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      G => \FSM_sequential_currState_reg_n_0_[1]\,
      GE => '1',
      Q => FIFO_elements(0)
    );
\FIFO_elements_reg[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\FIFO_elements_reg[1]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\FIFO_elements_reg[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"48"
    )
        port map (
...
\FIFO_elements_reg[2]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\FIFO_elements_reg[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7080"
    )
        port map (
...
\FIFO_elements_reg[3]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\FIFO_elements_reg[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7F008000"
    )
        port map (
...
\FIFO_elements_reg[4]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\FIFO_elements_reg[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\FIFO_elements_reg[5]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\FIFO_elements_reg[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"84"
    )
        port map (
...
\FIFO_elements_reg[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\FIFO_elements_reg[6]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\FIFO_elements_reg[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"84"
    )
        port map (
      I0 => \FIFO_elements_reg[7]_i_2_n_0\,
      I1 => \FSM_sequential_currState_reg_n_0_[1]\,
      I2 => FIFO_elements(6),
      O => \FIFO_elements_reg[6]_i_1_n_0\
    );
\FIFO_elements_reg[7]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\FIFO_elements_reg[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B040"
    )
        port map (
...
\FIFO_elements_reg[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_onehot_nextState_iAXI_reg[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => fifo_full,
      I3 => iAXI_valid,
      I4 => \FSM_onehot_currState_iAXI_reg_n_0_[1]\,
...
fifo_full_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
fifo_full_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
      I0 => FIFO_elements(3),
      I1 => FIFO_elements(1),
      I2 => fifo_full_reg_i_3_n_0,
      O => fifo_full_reg_i_1_n_0
    );
fifo_full_reg_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0F0E"
    )
        port map (
...
fifo_full_reg_i_3: unisim.vcomponents.LUT6
    generic map(
...
iAXI_ready_reg_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
        ...
        port map (
      I0 => \FSM_onehot_currState_iAXI_reg_n_0_[2]\,
      I1 => \FSM_onehot_currState_iAXI_reg_n_0_[1]\,
      I2 => currState_iAXI(0),
