...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_FIFO is
  ...
  signal \FIFO_elements_reg[7]_i_3_n_0\ : STD_LOGIC;
  ...
  signal fifo_write_done_reg_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FIFO_elements_reg[0]_i_1\ : label is "soft_lutpair6";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[1]\ : label is "LD";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[1]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \FIFO_elements_reg[5]_i_1\ : label is "soft_lutpair7";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[6]\ : label is "LD";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[6]_i_1\ : label is "soft_lutpair3";
  attribute XILINX_LEGACY_PRIM of \FIFO_elements_reg[7]\ : label is "LD";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FIFO_elements_reg[7]_i_2\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of fifo_full_reg_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of fifo_full_reg_i_2 : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM of fifo_write_done_reg : label is "LD";
  attribute SOFT_HLUTNM of fifo_write_done_reg_i_1 : label is "soft_lutpair4";
...
\FIFO_elements_reg[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\FIFO_elements_reg[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_onehot_nextState_reg[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF4"
    )
        port map (
...
fifo_full_reg_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEF0F0"
    )
        port map (
...
fifo_write_done_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
fifo_write_done_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
