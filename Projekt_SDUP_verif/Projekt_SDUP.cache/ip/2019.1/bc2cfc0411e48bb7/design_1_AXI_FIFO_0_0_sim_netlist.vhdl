...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_FIFO is
  ...
  attribute OPT_MODIFIED of fifo_write_done_reg : label is "MLO";
  ...
  attribute SOFT_HLUTNM of fifo_write_rdy_reg_i_2 : label is "soft_lutpair1";
...
\FSM_onehot_nextState_iAXI_reg[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EAEAFFEA"
    )
        port map (
...
\FSM_onehot_nextState_iAXI_reg[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8F88"
    )
        port map (
      ...
      I2 => fifo_write_done,
      I3 => \FSM_onehot_currState_iAXI_reg_n_0_[2]\,
...
\nextState_reg[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\nextState_reg[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
