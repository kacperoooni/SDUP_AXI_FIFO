...
xv_boost_lib_path=D:/Uczelnia/Vivado/Vivado/2019.1/tps/boost_1_64_0
xvlog_opts="--relax -L axi4stream_vip_v1_1_5 -L xilinx_vip"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axis_infrastructure_v1_1_0 -L xil_defaultlib -L axi4stream_vip_v1_1_5 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Uczelnia/Vivado/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
