...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Projekt_SDUP.srcs/sources_1/bd/design_1/ipshared/8713/hdl" \
       +incdir+"../../../../Projekt_SDUP.srcs/sources_1/bd/design_1/ipshared/8713/hdl" \
       +incdir+"D:/Uczelnia/Vivado/Vivado/2019.1/data/xilinx_vip/include"
}
