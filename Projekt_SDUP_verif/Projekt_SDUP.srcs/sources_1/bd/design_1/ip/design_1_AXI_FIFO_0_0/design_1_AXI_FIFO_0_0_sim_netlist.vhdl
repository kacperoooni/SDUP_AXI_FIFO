...
-- Date        : Tue Jun 14 09:51:34 2022
-- Host        : DESKTOP-DNFSS87 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Users/kacpe/OneDrive/Pulpit/Projekt_SDUP/Projekt_SDUP.srcs/sources_1/bd/design_1/ip/design_1_AXI_FIFO_0_0/design_1_AXI_FIFO_0_0_sim_netlist.vhdl
...
entity design_1_AXI_FIFO_0_0_AXI_FIFO is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_AXI_FIFO_0_0_AXI_FIFO : entity is "AXI_FIFO";
end design_1_AXI_FIFO_0_0_AXI_FIFO;

architecture STRUCTURE of design_1_AXI_FIFO_0_0_AXI_FIFO is
  ...
  signal \FIFO_input_buff[15]_i_1_n_0\ : STD_LOGIC;
  signal FIFO_input_buff_nxt : STD_LOGIC;
...
begin
\FIFO[0][15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\FIFO_input_buff[15]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00DF"
    )
        port map (
      ...
      I2 => iAXI_valid,
      I3 => currState_iAXI(1),
      O => \FIFO_input_buff[15]_i_1_n_0\
    );
\FIFO_input_buff[15]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => currState_iAXI(1),
      O => FIFO_input_buff_nxt
    );
\FIFO_input_buff_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(0),
      Q => FIFO_input_buff(0),
      R => \FIFO_input_buff[15]_i_1_n_0\
    );
\FIFO_input_buff_reg[10]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(10),
...
\FIFO_input_buff_reg[11]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(11),
...
\FIFO_input_buff_reg[12]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(12),
...
\FIFO_input_buff_reg[13]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(13),
...
\FIFO_input_buff_reg[14]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(14),
...
\FIFO_input_buff_reg[15]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(15),
...
\FIFO_input_buff_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(1),
...
\FIFO_input_buff_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(2),
...
\FIFO_input_buff_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(3),
...
\FIFO_input_buff_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(4),
...
\FIFO_input_buff_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(5),
...
\FIFO_input_buff_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(6),
...
\FIFO_input_buff_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(7),
...
\FIFO_input_buff_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(8),
...
\FIFO_input_buff_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => iAXI_aclk,
      CE => FIFO_input_buff_nxt,
      D => iAXI_data(9),
...
entity design_1_AXI_FIFO_0_0 is
  ...
  attribute NotValidForBitStream of design_1_AXI_FIFO_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_AXI_FIFO_0_0 : entity is "design_1_AXI_FIFO_0_0,AXI_FIFO,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_AXI_FIFO_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_AXI_FIFO_0_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_AXI_FIFO_0_0 : entity is "AXI_FIFO,Vivado 2019.1";
end design_1_AXI_FIFO_0_0;

architecture STRUCTURE of design_1_AXI_FIFO_0_0 is
...
begin
  \^aclk\ <= aclk;
  oAXI_aclk <= \^aclk\;
inst: entity work.design_1_AXI_FIFO_0_0_AXI_FIFO
     port map (
      aclk => \^aclk\,
      iAXI_aclk => iAXI_aclk,
